...
right: 10px;"><i class="fa fa-basket"></i></a> </p>
    ...
    <div class="header">
        ...
        <p style="font-size: 50px;font-family: 'Agency FB'"><b>FLORENCE</b></p>
        <p style="font-size: 20px;color: black">For Us</p>
    </div>
    ...
    <div class="topnav" id="myTopnav">
        ...
        if(!isset($_SESSION['username'])){
            echo "<a href='login.php'>Register As a beautician</a>";
...
<div class="row" style="background-color:#FFFFF2" >
    <div class="column"><img src="girl.png" alt="MAKE UP MODEL" style="width:100%"></div>
    <div class="column" style="width:70%; color:red; font:arial"><p>What are you looking for?</p>
    ...
    <div class="column">
    <figure>
    <input type="image" name="beautician"  onclick="toggleText_b()" src="beautician.png" style="width: 80px;">
    <figcaption style="color:red; font-size:20px;">Beauty artist</figcaption>
</figure>
<form method="GET" id="Myid">
<p style="font-size:20px; color:red;">In need of assistance for....</p>
<input type="text" name ="interest" placeholder="Henna/Sharee..." >
<p style="font-size:20px; ">Your thana?</p>
<input type="text" name="thana" color:red; placeholder="Badda/Vatara/etc">
<p></p>
...
<div class="column">
    <figure>
    <input type="image" name="outlet"  onclick="toggleText_o()" src="outlet.png" style="width: 80px;">
    <figcaption style="color:blue; font-size:20px;">Outlet</figcaption>
</figure>
<form method="GET" id="Myido">
<p  style="font-size:20px; color:blue;">Your thana?</p>
<input type="text" name="thana" placeholder="Badda/Vatara/etc">
<p></p>
...
function toggleText_o(){
  var x = document.getElementById("Myido");
    if (x.style.display === "none") {
        x.style.display = "block";
  } else {
        x.style.display = "none";
